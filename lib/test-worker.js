...
(opts.require || []).forEach(path => {
	if (
		opts.babelRegister && typeof opts.babelRegister === 'object' &&
		path.match(/node_modules\/babel-register\/lib\/[^\\\/]+\.js/)
	) {
		return require(path)(opts.babelRegister);
	}
